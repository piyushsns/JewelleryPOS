...
const useProductAPI = () => {
  ...
  const updateItem = async (id,payloadData) => {
    try {
      setLoading(true)
      var data = useServiceApi.update(`admin/catalog/products/${id}`, payloadData)
  ...
  return { loading, cartData, error, fetchCartData, storeItem, removeItem, getItem,updateItem }
}
